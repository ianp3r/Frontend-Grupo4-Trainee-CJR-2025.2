    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const res = await fetch('/api/auth/login', {
                ...
                // credentials: 'include' // uncomment if backend sets cookies and you want to include them
            });
            ...
            // If backend returns a token, save it (you can adjust to use cookies instead)
            if (data?.token) {
