            ...
            <div className="relative">
                ...
                <div className="ml-[116px] mt-[175px] flex gap-[36px] absolute top-[25px]">
                    ...
                    <div className="flex flex-col gap-[15px]">
                        ...
                        <h1 className="font-[League_Spartan] font-medium text-[52.56px] leading-[100%] text-black">Selena Gomez</h1>
                        <span className="font-[League_Spartan] font-light text-[29.15px] leading-[100%] text-black">@ selenagomez</span>
